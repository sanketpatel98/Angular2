...
export class AppComponent implements OnInit { 
  ...
  userForm = new FormGroup({
    name: new FormControl("Sanket",[Validators.required, Validators.minLength(4), Validators.maxLength(10)]),
  ...
  ngOnInit()
  {
    this.userForm = this._formBuilder.group({
      name: ['Sanket', [Validators.required, Validators.minLength(4), Validators.maxLength(10)]],
      email: [],
